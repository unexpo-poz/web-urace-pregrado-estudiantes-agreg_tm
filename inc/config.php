...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/agreg_tm/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso		= '2023-1';
$tLapso				= ' Lapso '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/agregados/agregado_3mat'.$lapsoProceso.'.log';
...
$mensajeppal = "Disculpe, el proceso culmin&oacute; el 26/05/2023";
