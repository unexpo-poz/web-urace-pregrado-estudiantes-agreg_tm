...
function excesoDeCreditosCCS(lSeccion) {
    ...
    maxCarga = new Array(5) //contiene maximo de creditos, condicion que aplica 
...
function resaltar(lSeccion) {
	...
	if (correquisitoOK(document.pensum)) {// Desactivar esta condicion para evitar revision de correquisitos
		if (vrPOZ()) {
		...
		if (!excesoC && /*inscribeMasBajo(lSeccion)*/true){// Se deahbilito en 2018-E
